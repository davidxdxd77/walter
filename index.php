    ...
    <div class="container">
        ...
        <div class="row">
            <div class="col-sm-8">
                ...
                <p>
                    <a class="btn btn-default btn-lg" href="about.php">Saber mas &raquo;</a>
                </p>
            </div>
            <div class="col-sm-4">
                <h2>Contactar</h2>
        ...
        <div class="row">
            <div class="col-sm-4">
                <img class="img-circle img-responsive img-center" src="img/notebook.png" alt="">
                <!--http://placehold.it/300x300-->
                <h2>Example #1</h2>
                <p>These marketing boxes are a great place to put some information. These can contain summaries of what the company does, promotional information, or anything else that is relevant to the company. These will usually be below-the-fold.</p>
            </div>
            <div class="col-sm-4">
                <img class="img-circle img-responsive img-center" src="img/tablet.png" alt="">
                <h2>Example #2</h2>
